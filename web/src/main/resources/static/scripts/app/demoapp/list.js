    ...
    var tableIns = table.render({
        ...
        cols: [[
            {type: "checkbox", fixed: "left", width: 50},
                    ...
                    {field: 'age', title:  'age', minWidth: 100, align: "center"},
                    {field: 'desc', title:  'desc', minWidth: 100, align: "center"},
    ...
    table.on('toolbar(List-toolbar)', function (obj) {
        if (obj.event == 'add') {
            layer.open({
                ...
                fixed: false,
                maxmin: true,
                content: web.rootPath() + 'demoapp/add.html'
            });
        }
        ;
    });
        ...
        switch (obj.event) {
            case 'update':
                layer.open({
                    ...
                    fixed: false,
                    maxmin: true,
                    content: web.rootPath() + "demoapp/" + data.id + ".html?_"
                });
                break;
            case 'delete':
                var index = layer.confirm('确定要删除?', {
                    ...
                    $.ajax({
                        url: web.rootPath() + "demoapp/delete/" + data.id,
                        type: "delete",
