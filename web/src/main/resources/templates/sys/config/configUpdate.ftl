        ...
        <form class="layui-form" action="" lay-filter="component-form-element">
            ...
            <div class="layui-row layui-col-space10 layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="configKey" readonly name="configKey" lay-verify="configKey"
                           placeholder="输入配置代码" value="${obj.configKey}"
            ...
            <div class="layui-input-block">
                <input type="text" id="parentKey" name="parentKey" lay-verify="parentKey"
                       placeholder="顶级配置可不填,默认-" value="${obj.parentKey}"
...
<script type="text/javascript"
        src="${request.contextPath}/static/scripts/sys/config/configUpdate.js?_=${randomNum}"></script>
</body>