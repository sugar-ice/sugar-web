            ...
            <div class="layui-row layui-form-item">
                ...
                <div class="layui-input-block text-input">
                    <#if sysMenu.menuType == 1>
                        <input type="radio" name="menu" checked="checked" lay-filter="menuType-radio" value="1"
                               title="目录"/>
                    <#elseif sysMenu.menuType == 2 || sysMenu.menuType == 3>
                        <input type="radio" name="menu" checked="checked" lay-filter="menuType-radio" value="2"
                               title="菜单"/>
                    <#elseif sysMenu.menuType ==4>
                        <input type="radio" name="menu" checked="checked" lay-filter="menuType-radio" value="4"
                               title="按钮"/>
                    </#if>
                </div>
            </div>
...
<script type="text/javascript"
        src="${request.contextPath}/static/scripts/sys/menu/menuUpdate.js?_=${randomNum}"></script>
</body>