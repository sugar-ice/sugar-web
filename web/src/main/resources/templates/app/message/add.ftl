        ...
        <form class="layui-form" action="" lay-filter="component-form-element">
            <div class="layui-row layui-col-space10 layui-form-item">
                ...
                <div class="layui-col-lg6">
                    ...
                    <div class="layui-input-block">
                        <input type="text"  name="messageType"  placeholder="请输入"  autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-col-lg6">
                        <label class="layui-form-label">消息发布人</label>
                    <div class="layui-input-block">
                        <input type="text"  name="publisherId"  placeholder="请输入"  autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-col-lg6">
                        <label class="layui-form-label">消息接收人，NULL表示所有人</label>
                    <div class="layui-input-block">
                        <input type="text"  name="receiverId"  placeholder="请输入"  autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-col-lg6">
                        <label class="layui-form-label">消息简介</label>
                    <div class="layui-input-block">
                        <input type="text"  name="messageSummary"  placeholder="请输入"  autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-col-lg6">
                ...
                <div class="layui-col-lg6">
                    ...
                    <div class="layui-input-block">
                        <input type="text"  name="messageImage"  placeholder="请输入"  autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-col-lg6">
                        <label class="layui-form-label">置顶优先级，数字越大排的越前面，0表示不置顶</label>
                    <div class="layui-input-block">
                        <input type="text"  name="topPriority"  placeholder="请输入"  autocomplete="off" class="layui-input">
                    </div>
                </div>
...
<script type="text/javascript" src="${request.contextPath}/scripts/app/message/add.js?_=${randomNum}"></script>
</body>
