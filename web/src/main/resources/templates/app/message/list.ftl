    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <@sec.authenticate grants="app:message:list">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="List-editBar">
                        <@sec.authenticate grants="app:message:update">
                            <a class="layui-btn layui-btn-xs layui-btn-primary" lay-event="read"><i
                                        class="layui-icon">&#xe642;</i>已读</a>
                        </@sec.authenticate>
                        <@sec.authenticate grants="app:message:delete">
                            <a class="layui-btn layui-btn-xs layui-btn-primary" lay-event="delete"><i
                                        class="layui-icon">&#xe640;</i>删除</a>
                        </@sec.authenticate>
                        <a class="layui-btn layui-btn-xs layui-btn-primary" lay-event="view"><i
...
<script type="text/javascript" src="${request.contextPath}/scripts/app/message/list.js?_=${randomNum}"></script>
</body>
</html>
