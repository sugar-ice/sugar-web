    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <@sec.authenticate grants="app:tbContract:list">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="List-toolbar">
                        <div class="layui-btn-container">
                            <@sec.authenticate grants="app:tbContract:add">
                    ...
                    <script type="text/html" id="List-editBar">
                        ...
                        <@sec.authenticate grants="app:tbContract:delete">
...
<script type="text/javascript" src="${request.contextPath}/scripts/app/tbContract/list.js?_=${randomNum}"></script>
</body>
</html>
