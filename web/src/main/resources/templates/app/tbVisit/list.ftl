    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <@sec.authenticate grants="app:tbVisit:list">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="List-toolbar">
                        <div class="layui-btn-container">
                            <@sec.authenticate grants="app:tbVisit:add">
...
<script type="text/javascript" src="${request.contextPath}/scripts/app/tbVisit/list.js?_=${randomNum}"></script>
</body>
</html>
