        ...
        <form class="layui-form" action="" lay-filter="component-form-element">
            <div class="layui-row layui-col-space10 layui-form-item">
                ...
                <div class="layui-col-lg6" style="margin-top: 10px">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="deliverTime" name="deliverTime" placeholder="请输入" autocomplete="off"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-col-lg6" style="margin-top: 10px">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="receiveTime" name="receiveTime" placeholder="请输入" autocomplete="off"
                               class="layui-input">
                    </div>
                </div>
