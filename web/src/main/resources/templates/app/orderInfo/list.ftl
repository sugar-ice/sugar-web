    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <@sec.authenticate grants="app:orderInfo:list">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="List-toolbar">
                        <div class="layui-btn-container">
                            <@sec.authenticate grants="app:orderInfo:add">
                    ...
                    <script type="text/html" id="List-editBar">
                        ...
                        <@sec.authenticate grants="app:orderInfo:delete">
...
<script type="text/javascript" src="${request.contextPath}/scripts/app/orderInfo/list.js?_=${randomNum}"></script>
</body>
</html>
