    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <@sec.authenticate grants="app:demoapp:list">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="List-toolbar">
                        <div class="layui-btn-container">
                            <@sec.authenticate grants="app:demoapp:add">
...
<script type="text/javascript" src="${request.contextPath}/scripts/app/demoapp/list.js?_=${randomNum}"></script>
</body>
</html>
